...
Uma plataforma integrada que **Ativa** o cidadão com notícias traduzidas para um português "não jurídico" publicadas em redes sociais, como: tiktok e instagram. Com objetivo de **engajar** o usuário a ir para o WhatsApp, onde o mesmo **Interage** através de um chatbot com IA e **Captura** o sentimento popular dos assuntos sobre Leis e Projetos governamentais para por fim, gerar indicadores de impacto que são enviados diretamente aos orgãos competentes como: governos estaduais, municipais e senado federal.
